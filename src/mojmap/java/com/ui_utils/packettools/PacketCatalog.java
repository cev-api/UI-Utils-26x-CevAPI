...
public enum PacketCatalog {
	...
	private static final Set<String> S2C = new TreeSet<>(String.CASE_INSENSITIVE_ORDER);
	private static final Set<String> C2S = new TreeSet<>(String.CASE_INSENSITIVE_ORDER);
